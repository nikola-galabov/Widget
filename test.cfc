...
<cfset qFiltered = QueryNew("Name, Time, Advanced", "VarChar, Time, Bit")> 

<!--- Make two rows in the query ---> 
<cfset newRow = QueryAddRow(qFiltered, 2)> 
 
<!--- Set the values of the cells in the query ---> 
<cfset temp = QuerySetCell(qFiltered, "Name", "The Wonderful World of CMFL", 1)> 
<cfset temp = QuerySetCell(qFiltered, "Time", "9:15 AM", 1)> 
<cfset temp = QuerySetCell(qFiltered, "Advanced", False, 1)> 
<cfset temp = QuerySetCell(qFiltered, "Name", "CFCs for Enterprise 
        Applications", 2)> 
<cfset temp = QuerySetCell(qFiltered, "Time", "12:15 PM", 2)> 
<cfset temp = QuerySetCell(qFiltered, "Advanced", True, 2)> 
